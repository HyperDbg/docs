...
Shows or changes the current process. These commands can only be used in **Debugger Mode**. Please take a look at the [**Remarks**](https://docs.hyperdbg.org/commands/meta-commands/.process#remarks) for more information about the difference between the '**.process**' and the '**.process2**' commands.
...
{% hint style="success" %}
If you don't specify any parameters to the '**.process**' or the '**.process2**' commands, it shows the current process.
{% endhint %}
