...
In remote connection when you're connected to the debuggee using the '[.listen](https://docs.hyperdbg.com/commands/meta-commands/.listen)' command, the symbol server should be located \(and it will be accessed\) in the remote computer.
