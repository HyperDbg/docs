...
> !msread \[msr \(hex value\)\] \[pid \(hex value\)\] \[core \(hex value\)\] \[event options\]
...
Both **!msrread** and **!msrwrite** use the vm-exits caused by setting bits in MSR Bitmap field of the hypervisor.
