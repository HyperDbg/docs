...
In HyperDbg [check\_address](https://docs.hyperdbg.org/commands/scripting-language/functions/memory/check\_address) function is used to check an address to see if the address is **valid** and **safe to access** from or not.
