...
* [Scripting Language](commands/scripting-language/README.md)
  ...
  * [Functions](commands/scripting-language/functions/README.md)
    ...
    * [interlocked\_compare\_exchange](commands/scripting-language/functions/interlocked_compare_exchange.md)
    * [interlocked\_decrement](commands/scripting-language/functions/interlocked_decrement.md)
    * [interlocked\_exchange](commands/scripting-language/functions/interlocked_exchange.md)
    * [interlocked\_exchange\_add](commands/scripting-language/functions/interlocked_exchange_add.md)
    * [interlocked\_increment](commands/scripting-language/functions/interlocked_increment.md)
    ...
    * [spinlock\_lock](commands/scripting-language/functions/spinlock_lock.md)
    * [spinlock\_unlock](commands/scripting-language/functions/spinlock_unlock.md)
    * [spinlock\_lock\_custom\_wait](commands/scripting-language/functions/spinlock_lock_custom_wait.md)
    * [strlen](commands/scripting-language/functions/strlen.md)
    * [wcslen](commands/scripting-language/functions/wcslen.md)
